...
function captureFullState() {
    ...
    return {
        ...
        // --- NEW: SAVE WAR CONFIG ---
        // Uses global warConfig from tech-planner.js
...
function init() {
    ...
    // --- NEW: Init War Defaults (Before Load) ---
    // If these don't exist in save, we want them to start at Tue 12 AM
